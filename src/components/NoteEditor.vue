<template>
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
    ...
    <div v-else class="flex items-center justify-center h-96 text-center">
      <div>
        <Edit3 :size="48" class="mx-auto text-gray-300 dark:text-gray-600 mb-4" />
        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No note selected</h3>
        <p class="text-gray-500 dark:text-gray-400 mb-4">Select a note from the sidebar or create a new one</p>
        <button
...
import { Pin, X, Edit3, Plus } from 'lucide-vue-next'
